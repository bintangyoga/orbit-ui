    ...
    <div className="p-8 max-w-3xl space-y-10">
      <div>
        ...
        <p className="text-[var(--orbit-muted-foreground)]">
          Displays a button with glass gradient effects and inner depth.
        </p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="text-sm text-[var(--orbit-muted-foreground)] space-y-3">
          ...
          <div>
            ...
            <p><code className="bg-[var(--orbit-muted)] px-1.5 py-0.5 rounded text-[var(--orbit-foreground)]">"sm" | "default" | "lg" | "icon"</code></p>
          </div>
          <div>
